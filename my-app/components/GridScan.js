...
uniform float uGridScrollSpeed; 
varying vec2 vUv;
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    // We shift the Y coordinate of the UVs based on time and speed
    gridUV.y += iTime * uGridScrollSpeed; 
    ...
    // --- SCROLLING LOGIC FOR SECONDARY GRID ---
    gridUV2.y += iTime * uGridScrollSpeed; 
...
export const GridScan = ({
  ...
  scanOpacity = 0.4,
  gridScale = 0.1,
  gridScrollSpeed = 0.1, // Default scroll speed
  lineStyle = 'solid',
  lineJitter = 0.1,
  ...
  useEffect(() => {
    ...
    const uniforms = {
      ...
      uGridScrollSpeed: { value: gridScrollSpeed },
  ...
  useEffect(() => {
    ...
    if (m) {
      ...
      u.uGridScrollSpeed.value = gridScrollSpeed;
